...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark justify-content-center">
	...
	<ul class="navbar-nav">
		...
		<li class="nav-item"><a class="nav-link text-white" href="${url}/shipment/reg">SHIPMENT REG</a></li>
		<li class="nav-item"><a class="nav-link text-white" href="${url}/shipment/all">SHIPMENT DATA</a></li>
