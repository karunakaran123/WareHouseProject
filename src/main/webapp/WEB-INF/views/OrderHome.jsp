...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark justify-content-center">
    ...
    <li class="nav-item">
      <a class="nav-link" href="#">Link 2</a>
		...
		<li class="nav-item"><a class="nav-link text-white" href="${url}/order/reg">ORDER REG</a></li>
		<li class="nav-item"><a class="nav-link text-white" href="${url}/order/all">ODER DATA</a></li>
