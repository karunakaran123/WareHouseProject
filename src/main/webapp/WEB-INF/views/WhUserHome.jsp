...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark justify-content-center ">
	...
	<ul class="navbar-nav">
		...
		<li class="nav-item"><a class="nav-link text-white" href="${url}/whuser/reg">WhUSER REG</a></li>
		<li class="nav-item"><a class="nav-link text-white" href="${url}/whuser/all">WhUSER DATA</a></li>
