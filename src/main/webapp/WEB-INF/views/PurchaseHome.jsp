...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark justify-content-center">
    ...
    <li class="nav-item">
      <a class="nav-link" href="#">Link 2</a>
		...
		<li class="nav-item"><a class="nav-link text-white" href="${url}/purchase/reg">PURCAHSE REG</a></li>
		<li class="nav-item"><a class="nav-link text-white" href="${url}/purchase/all">PURCHASE DATA</a></li>
